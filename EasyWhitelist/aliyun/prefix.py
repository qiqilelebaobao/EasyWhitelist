...
class Prefix:
    ...
    def create_prefix_list(self, prefix_list_name: str = TEMPLATE_PREFIX + "0", description: str = TEMPLATE_PREFIX + "0_desc") -> Optional[Dict[str, Any]]:
    ...
    def _associate_prefix_list_with_id(self, prefix_list_id: str) -> Optional[Dict[str, Any]]:
    ...
    def list_prefix_list(self) -> Optional[Dict[str, Any]]:
